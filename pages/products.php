...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column">
                <img src="../images/images for the website/NANCY'S BOTTLES-03.jpg" style="width: 100%">
                <img src="../images/images for the website/RYNADEL-06.jpg" style="width: 100%">
                <img src="../images/images for the website/titbits small.jpg" style="width: 100%">
                <img src="../images/images for the website/platain chips.jpg" style="width: 100%">

            </div>
            <div class="column">
                <img src="../images/images for the website/RYNADEL-04.jpg" style="width: 100%">
                <img src="../images/images for the website/RYNADEL-07.jpg" style="width: 100%">
                <img src="../images/images for the website/RYNADEL 2-01.jpg" style="width: 100%">
                

            </div>
            <div class="column">
                <img src="../images/images for the website/RYNADEL-05.jpg" style="width: 100%">
                <img src="../images/images for the website/new labels sample-03.jpg" style="width: 100%">
                <img src="../images/images for the website/atsomor.jpg" style="width: 100%">
            </div>
