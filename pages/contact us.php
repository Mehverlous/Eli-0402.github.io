...
<html>
    <head>
        ...
        <html lang ="en">
        <title>
            Rynadell Foods | Contact us
        </title>
    </head>
    <body>
        <br>
        <br>
        <img src="../images/images for the website/64653.jpg" alt="">
        ...
        <div id="contact_information">
            ...
            <div id="column">
                    ...
                    <p>Telephone: 02123456789 <br>
                        Email: rynadellfoods@gmail.com
                    </p>
            </div>

            <div id="column">
                    <h2>Sales info & inquires:</h2>
                    <p>Telephone: 02987654321 <br>
                        Fax: 123-456
                    </p>
            </div>
